...
``tests/test_gui_candidates.py``, ``tests/test_gui_repair.py``) -- and,
transitively, of the pytest-qt plugin's own Qt-binding detection -- in
an environment where the optional ``[gui]`` extra (PySide6) is not
installed.
"""
